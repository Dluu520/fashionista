...
const Hero = ({ title, message, button }) => {
  return (
    <div className="flex items-center justify-center h-screen  bg-fixed bg-center bg-cover hero-image">
      {/* Overlay */}
      <div
      ...
      />
      {/* content */}
      <div className="p-5 flex flex-col items-start bottom-20 sm:left-20 absolute text-white z-[2]">
